...
register_activation_hook( FORM_SENTINEL_FILE, array( 'Form_Sentinel_Installer', 'activate' ) );
register_deactivation_hook( FORM_SENTINEL_FILE, array( 'Form_Sentinel_Installer', 'deactivate' ) );
